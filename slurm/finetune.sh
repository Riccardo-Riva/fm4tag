...
OUTPUT_BASE=${REPO}/slurm/finetuning
...
# Path to the PretrainModule checkpoint whose encoder weights are loaded
# (set this to your pretrain run's best/last checkpoint before submitting).
ENCODER_CKPT=${REPO}/slurm/pretraining/run_20260320_112055/model_0_colrow/version_0/checkpoints/last.ckpt
